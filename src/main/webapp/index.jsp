...
<body class="font-[Inter] bg-[#f8fafc] text-black overflow-x-hidden">
  ...
  <div class="relative z-10 min-h-screen flex flex-col">
    <div class="border-b border-black/5 px-6 py-2 flex justify-between text-[9px] text-gray-400 uppercase tracking-[0.3em] font-bold bg-white/80 backdrop-blur-md">
        <span>GURUKUL_ILE // LEARNING_PLATFORM</span>
    ...
    <main class="flex-grow flex flex-col pt-20">
      <section class="px-6 md:px-20 mb-20">
        ...
        <div class="grid md:grid-cols-2 mt-12 gap-12 items-end">
            <div class="border-l-4 border-black pl-8 py-4">
                <p class="text-2xl font-medium text-gray-800 mb-4 leading-tight uppercase tracking-tight">The ultimate platform for modern academic excellence.</p>
                <p class="text-gray-400 text-xs leading-loose max-w-md font-bold uppercase tracking-widest italic opacity-60">Integrated Learning Environment optimized for precision Sessions and centralized Student Management.</p>
            </div>
            <div class="bg-black text-white p-12 relative overflow-hidden group">
                <div class="absolute top-0 right-0 p-4 text-[9px] font-mono opacity-20">ONLINE</div>
      ...
      <section class="grid grid-cols-1 md:grid-cols-3 border-y border-black/5 bg-white/30 backdrop-blur-sm">
        <div class="p-10 border-r border-black/5 group hover:bg-white transition-all">
            ...
            <h3 class="font-[Orbitron] text-xs font-black uppercase mb-4 tracking-widest">Smart Dashboard</h3>
            <p class="text-[10px] text-gray-400 font-bold uppercase leading-relaxed tracking-widest opacity-60">Real-time monitoring and academic data tracking for both students and teachers.</p>
        </div>
        <div class="p-10 border-r border-black/5 group hover:bg-white transition-all">
            <span class="text-[8px] text-red-500 font-bold tracking-widest block mb-4 uppercase">MODULE_02</span>
            <h3 class="font-[Orbitron] text-xs font-black uppercase mb-4 tracking-widest">Live Sessions</h3>
            <p class="text-[10px] text-gray-400 font-bold uppercase leading-relaxed tracking-widest opacity-60">Encrypted live-stream sessions for instant knowledge transfer.</p>
        </div>
        <div class="p-10 group hover:bg-white transition-all">
            ...
            <h3 class="font-[Orbitron] text-xs font-black uppercase mb-4 tracking-widest">User Registry</h3>
            <p class="text-[10px] text-gray-400 font-bold uppercase leading-relaxed tracking-widest opacity-60">Secure account management with high-density student enrollment systems.</p>
        </div>
      </section>
    </main>
